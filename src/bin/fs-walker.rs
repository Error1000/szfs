...
fn main() {
    ...
    let mut system_attributes = zpl::SystemAttributes::from_attributes_node_number(system_attributes_info_number as usize, &mut head_dataset_object_set, &mut vdevs).unwrap();
